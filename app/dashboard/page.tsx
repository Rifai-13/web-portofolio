      ...
      <SidebarProvider className="flex flex-col">
        ...
        <div className="flex">
          ...
          <div className="flex-1 p-6">
            <section className="max-w-2xl mx-auto mt-20 ml-20">
              <p className=" text-card-foreground leading-relaxed text-gray-600">
              ...
              <p className="text-card-foreground leading-relaxed mt-4 text-gray-600">
